			...
			if Config.MaxInService ~= -1 then
				ESX.TriggerServerCallback('esx_service:isInService', function(isInService)
					if isInService then
						...
						TriggerEvent('esx_cripsjob:updateBlip')
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('esx_cripsjob:storeNearbyVehicle', function(storeSuccess, foundNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_cripsjob:buyJobVehicle', function (bought)
					if bought then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						...
						--TriggerServerEvent('esx:search', "Crips")
						TriggerServerEvent('esx_cripsjob:message', GetPlayerServerId(closestPlayer), _U('being_searched'))
...
function LookupVehicle()
	ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'lookup_vehicle',
	{
		...
		if data.value == nil or length < 2 or length > 13 then
			...
			ESX.TriggerServerCallback('esx_cripsjob:getVehicleFromPlate', function(owner, found)
				if found then
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_cripsjob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			TriggerServerEvent('esx_cripsjob:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
function OpenVehicleInfosMenu(vehicleData)
	ESX.TriggerServerCallback('esx_cripsjob:getVehicleInfos', function(retrivedInfo)
...
function OpenBuyWeaponsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons', {
		...
		if data.current.hasWeapon then
			...
			ESX.TriggerServerCallback('esx_cripsjob:buyWeapon', function(bought)
				if bought then
...
AddEventHandler('esx:setJob', function(job)
	...
	Citizen.Wait(5000)
	TriggerServerEvent('esx_cripsjob:forceBlip')
end)
...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if PlayerData.job and PlayerData.job.name == 'crips' and PlayerData.job.name == dispatchNumber then
...
AddEventHandler('esx_cripsjob:hasEnteredEntityZone', function(entity)
	...
	if PlayerData.job and PlayerData.job.name == 'crips' and IsPedOnFoot(playerPed) then
...
RegisterNetEvent('esx_cripsjob:unrestrain')
AddEventHandler('esx_cripsjob:unrestrain', function()
	if isHandcuffed then
		local playerPed = PlayerPedId()
		isHandcuffed = false
...
AddEventHandler('esx_cripsjob:drag', function(copId)
...
AddEventHandler('esx_cripsjob:OutVehicle', function()
	local playerPed = PlayerPedId()
...
Citizen.CreateThread(function()
	while true do
		...
		if PlayerData.job and PlayerData.job.name == 'crips' then
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, 38) and PlayerData.job and PlayerData.job.name == 'crips' then
		...
		if IsControlJustReleased(0, 167) and PlayerData.job and PlayerData.job.name == 'crips' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'crips_actions') then
			if Config.MaxInService == -1 then
...
RegisterNetEvent('esx_cripsjob:updateBlip')
AddEventHandler('esx_cripsjob:updateBlip', function()
...
AddEventHandler('playerSpawned', function(spawn)
	isDead = false
	TriggerEvent('esx_cripsjob:unrestrain')

	if not hasAlreadyJoined then
		TriggerServerEvent('esx_cripsjob:spawned')
	end
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		TriggerEvent('esx_cripsjob:unrestrain')
		TriggerEvent('esx_phone:removeSpecialContact', 'crips')
