...
function OpenCloakroomMenu()
	...
	if Config.EnableNonFreemodePeds then
		...
		table.insert(elements, {label = 'Vagos wear', value = 'freemode_ped', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'})
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, 167) and PlayerData.job and PlayerData.job.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') then
			if Config.MaxInService == -1 then
