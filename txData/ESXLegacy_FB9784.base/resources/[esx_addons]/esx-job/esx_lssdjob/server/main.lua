...
RegisterServerEvent('esx_lssdjob:confiscatePlayerItem')
...
RegisterServerEvent('esx_lssdjob:handcuff')
...
RegisterServerEvent('esx_lssdjob:drag')
...
RegisterServerEvent('esx_lssdjob:putInVehicle')
...
RegisterServerEvent('esx_lssdjob:OutVehicle')
...
RegisterServerEvent('esx_lssdjob:getStockItem')
...
RegisterServerEvent('esx_lssdjob:putStockItems')
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		...
		if xPlayer ~= nil and xPlayer.job ~= nil and xPlayer.job.name == 'lssd' then
			Citizen.Wait(5000)
...
RegisterServerEvent('esx_lssdjob:spawned')
...
RegisterServerEvent('esx_lssdjob:forceBlip')
...
RegisterServerEvent('esx_lssdjob:message')
AddEventHandler('esx_lssdjob:message', function(target, msg)
